...
const HotelSearchDialogBox = ({ open, onClose, onSearch }) => {
      ...
      <DialogTitle className={styles.dialogTitle}>
        <div className={styles.titleContainer}>
          <div className={styles.titleIcon}>
            <HotelIcon color='primary' sx={{ fontSize: '36px' }} />
          </div>
          <div>
            <h2>Enter your Distentions ?</h2>
...
export default HotelSearchDialogBox
