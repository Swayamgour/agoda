      ...
      <div  className="container">
        <div className="tabs -pills-2 js-tabs">
              ...
              <div className="tabs__controls row x-gap-10 justify-center js-tabs-controls">
                {tabs.map((tab) => (
                  <div key={tab.id} className="col-auto">
                    <button
                      className={`tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button ${tab.active ? 'is-tab-el-active' : ''}`}
          ...
          <div className="tabs__content pt-40 js-tabs-content">
            {tabs.map((tab) => (
              <div key={tab.id} className={`tabs__pane -tab-item-${tab.id} ${tab.active ? 'is-tab-el-active' : ''}`}>
                      ...
                      <a href="hotel-single-1.html" className="hotelsCard -type-1">
                          ...
                          <div className="cardImage ratio ratio-1:1">
                            <div className="cardImage__content">
                              {hotel.slider ? (
                                <div className="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider">
                                  <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                      <img className="col-12" src={hotel.image} alt="image" />
                                    </div>
                                    <div className="swiper-slide">
                                      <img className="col-12" src="/img/hotels/1.png" alt="image" />
                                    </div>
                                    <div className="swiper-slide">
                                      <img className="col-12" src="/img/hotels/3.png" alt="image" />
                                    </div>
                                  </div>
                                ...
                                <img className="rounded-4 col-12" src={hotel.image} alt="image" />
                              )}
                            </div>
                            ...
                            {hotel.badge && (
                              <div className="cardImage__leftBadge">
                                <div className={`py-5 px-15 rounded-right-4 text-12 lh-16 fw-500 uppercase ${hotel.badgeColor}`}>
                                  {hotel.badge}
                                </div>
                              </div>
                            )}
                        ...
                        <div className="hotelsCard__content mt-10">
                          ...
                          <div className="d-flex items-center mt-20">
                            <div className="flex-center bg-blue-1 rounded-4 size-30 text-12 fw-600 text-white">{hotel.rating}</div>
                            <div className="text-14 text-dark-1 fw-500 ml-10">Exceptional</div>
                            <div className="text-14 text-light-1 ml-10">{hotel.reviews}</div>
                          </div>

                          <div className="mt-5">
                            <div className="fw-500">
                              Starting from <span className="text-blue-1">{hotel.price}</span>
                            </div>
                          </div>
                        </div>
                      </a>
